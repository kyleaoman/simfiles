...
def h_a_powers(vals, path, fname, hpath, force_a=None, force_h=None):
    ...
    aexp_scale_exponent = (
        hdf5_get(*args, attr="aexp-scale-exponent") if force_a is None else force_a
    )
    h_scale_exponent = (
        hdf5_get(*args, attr="h-scale-exponent") if force_h is None else force_h
    )
    return np.power(vals.Header_attr_HubbleParam, h_scale_exponent) * np.power(
        vals.Header_attr_Time, aexp_scale_exponent
    )
...
def generate_extra_extractors(
    ...
    def mu(vals):
        return 1.0 / (
            vals.RuntimePars_attr_InitAbundance_Hydrogen
            + 0.25 * vals.RuntimePars_attr_InitAbundance_Helium
        )
    ...
    extractors["mHneutral_g"] = extractor(
        ...
        hpath=None,
        attr=None,
        convert=lambda vals, raw, path, fname, hpath: getattr(
            vals, f"PartType0_{Mstring}"
        )
        * vals.PartType0_ElementAbundance_Hydrogen
        * neutral_frac(
    ...
    extractors["mH2_g"] = extractor(
        keytype="particle0",
        filetype=default_pfiletype,
        dependencies=("mHneutral_g", "mHI_g"),
        hpath=None,
        attr=None,
        convert=lambda vals, raw, path, fname, hpath: vals.mHneutral_g - vals.mHI_g,
        units=None,
        unit_convert=U.Msun,
    )

    extractors["mHionized_g"] = extractor(
        keytype="particle0",
        filetype=default_pfiletype,
        dependencies=(
            f"PartType0_{Mstring}",
...
def generate_eagle_extractors(
    ...
    extractors["Header_attr_BoxSize"] = extractor(
        keytype="meta",
        filetype="snapshot",
        dependencies=("Units_attr_UnitLength_in_cm", "Header_attr_HubbleParam"),
        hpath="/Header",
        attr="BoxSize",
        convert=lambda vals, raw, path, fname, hpath: raw
    ...
    extractors["Header_attr_MassTable"] = extractor(
        keytype="meta",
        filetype="snapshot",
        dependencies=("Units_attr_UnitMass_in_g", "Header_attr_HubbleParam"),
        hpath="/Header",
        attr="MassTable",
        convert=lambda vals, raw, path, fname, hpath: raw[1]
        / vals.Header_attr_HubbleParam
    ...
    extractors["FOF_GroupLength"] = extractor(
        ...
        attr=None,
        convert=lambda vals, raw, path, fname, hapth: raw,
        units=None,
        unit_convert=None,
    )
    ...
    for ts in ("NSF", "SF", "Stars"):
        for smooth in ("", "Smoothed"):
            for element in elements:
                extractors[
                    "Subhalo_{:s}_{:s}ElementAbundance_{:s}".format(ts, smooth, element)
                ] = extractor(
                    keytype="group",
                    filetype="group",
                    dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
            ...
            extractors["Subhalo_{:s}_IronFromSNIa{:s}".format(ts, smooth)] = extractor(
                keytype="group",
                filetype="group",
                dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
        ...
        for src in ("AGB", "SNII", "SNIa"):
            extractors["Subhalo_{:s}_MassFrom{:s}".format(ts, src)] = extractor(
                keytype="group",
                filetype="group",
                dependencies=(
                    "Header_attr_HubbleParam",
            ...
            extractors["Subhalo_{:s}_MetalsFrom{:s}".format(ts, src)] = extractor(
                keytype="group",
                filetype="group",
                dependencies=(
                    "Header_attr_HubbleParam",
        ...
        extractors["Subhalo_{:s}_MassWeightedPotential".format(ts)] = extractor(
            keytype="group",
            filetype="group",
            dependencies=(
                "Header_attr_HubbleParam",
        ...
        for smooth in ("", "Smoothed"):
            extractors["Subhalo_{:s}_{:s}Metallicity".format(ts, smooth)] = extractor(
                keytype="group",
                filetype="group",
                dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
    ...
    for ts in ("NSF", "SF"):
        extractors["Subhalo_{:s}_MassWeightedEntropy".format(ts)] = extractor(
            ...
            attr=None,
            convert=lambda vals, raw, path, fname, hpath: raw
            * np.power(vals.Header_attr_HubbleParam, 2 - 2 * vals.Constants_attr_GAMMA)
            * vals.Units_attr_UnitPressure_in_cgs
            * np.power(vals.Units_attr_UnitDensity_in_cgs, -vals.Constants_attr_GAMMA),
            units=U.erg * U.K**-1,
            unit_convert=None,
        )

        extractors["Subhalo_{:s}_MassWeightedTemperature".format(ts)] = extractor(
            keytype="group",
            filetype="group",
            dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
    ...
    for Ti in set((0, 4)).intersection(T):
        extractors["PartType{:d}_AExpMaximumTemperature".format(Ti)] = extractor(
            keytype="particle{:d}".format(Ti),
            filetype=default_pfiletype,
            dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
        ...
        for smooth in ("Smoothed", ""):
            for element in elements:
                extractors[
                    "PartType{:d}_{:s}ElementAbundance_{:s}".format(Ti, smooth, element)
                ] = extractor(
                    keytype="particle{:d}".format(Ti),
                    filetype=default_pfiletype,
                    dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
            ...
            extractors["PartType{:d}_{:s}Metallicity".format(Ti, smooth)] = extractor(
                keytype="particle{:d}".format(Ti),
                filetype=default_pfiletype,
                dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
                hpath="/PartType{:d}/{:s}Metallicity".format(Ti, smooth),
                attr=None,
                convert=lambda vals, raw, path, fname, hpath: raw
                * h_a_powers(vals, path, fname, hpath),
                units=U.dimensionless_unscaled,
        ...
        extractors["PartType{:d}_MetalMassWeightedRedshift".format(Ti)] = extractor(
            keytype="particle{:d}".format(Ti),
            filetype=default_pfiletype,
            dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
        ...
        extractors["PartType{:d}_SmoothedIronMassFracFromSNIa".format(Ti)] = extractor(
            keytype="particle{:d}".format(Ti),
            filetype=default_pfiletype,
            dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
    ...
    extractors["PartType5_BH_Pressure"] = extractor(
        ...
        attr=None,
        convert=lambda vals, raw, path, fname, hpath: raw
        * np.power(vals.Header_attr_HubbleParam, 2)
    ...
    extractors["RuntimePars_attr_BlackHoleNumberOfNeighboursToHeat"] = extractor(
        keytype="meta",
        filetype="snapshot",
        dependencies=tuple(),
        hpath="/RuntimePars",
    ...
    extractors["RuntimePars_attr_EOS_Cool_MinPhysDens_HpCM3"] = extractor(
        keytype="meta",
        filetype="snapshot",
        dependencies=("Constants_attr_PROTONMASS",),
        hpath="/RuntimePars",
        attr="EOS_Cool_MinPhysDens_HpCM3",
        convert=lambda vals, raw, path, fname, hpath: vals.Constants_attr_PROTONMASS.to(
            U.g
        ).value
        * raw,
        units=U.g * U.cm**-3,
    ...
    for element in elements:
        extractors["RuntimePars_attr_InitAbundance_{:s}".format(element)] = extractor(
            keytype="meta",
            filetype="snapshot",
            dependencies=tuple(),
            hpath="/RuntimePars",
    ...
    extractors["RuntimePars_attr_REION_H_Heating_EVpH"] = extractor(
        ...
        convert=lambda vals, raw, path, fname, hpath: raw
        / vals.Constants_attr_PROTONMASS.to(U.g).value,
        units=U.eV * U.g**-1,
    ...
    extractors["RuntimePars_attr_SF_SchmidtLawHighDensThresh_HpCM3"] = extractor(
        keytype="meta",
        filetype="snapshot",
        dependencies=tuple(),
        hpath="/RuntimePars",
    ...
    extractors["RuntimePars_attr_SF_THRESH_MetDepSFThreshMaxThresh_HpCM3"] = extractor(
        keytype="meta",
        filetype="snapshot",
        dependencies=tuple(),
        hpath="/RuntimePars",
    ...
    extractors["RuntimePars_attr_SF_THRESH_MetDepSFThreshNorm_HpCM3"] = extractor(
        keytype="meta",
        filetype="snapshot",
        dependencies=tuple(),
        hpath="/RuntimePars",
    ...
    for element in elements:
        extractors["RuntimePars_attr_SNII_Factor_{:s}".format(element)] = extractor(
            keytype="meta",
            filetype="snapshot",
            dependencies=tuple(),
            hpath="/RuntimePars",
    ...
    extractors["RuntimePars_attr_StellarEvolutionTimestepInterval"] = extractor(
        keytype="meta",
        filetype="snapshot",
        dependencies=tuple(),
        hpath="/RuntimePars",
    ...
    for ts in ("NSF", "SF", "Stars"):
        ...
        for smooth in ("", "Smoothed"):
            for element in elements:
                extractors[
                    "FOF_{:s}_{:s}ElementAbundance_{:s}".format(ts, smooth, element)
                ] = extractor(
                    keytype="fofgroup",
                    filetype="fof",
                    dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
            ...
            extractors["FOF_{:s}_{:s}Metallicity".format(ts, smooth)] = extractor(
                keytype="fofgroup",
                filetype="fof",
                dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
        ...
        extractors["FOF_{:s}_SmoothedIronMassFracFromSNIa".format(ts)] = extractor(
            keytype="fofgroup",
            filetype="fof",
            dependencies=("Header_attr_HubbleParam", "Header_attr_Time"),
